...
export default function GhanaCardScanner() {
  ...
  // Modify the sendToBackend function in GhanaCardScanner.jsx
  const sendToBackend = async () => {
    ...
    console.log("[Smart-Capture] Converting canvas to base64...");

    try {
      // Get base64 image from canvas
      const base64Image = captureRef.current.toDataURL("image/jpeg", 0.9);
